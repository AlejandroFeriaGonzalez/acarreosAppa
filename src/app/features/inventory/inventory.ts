...
export class Inventory {
  ...
  readonly bisonData: Signal<Bison[]> = signal([
    ...
    { id: 2, name: 'Nimbus', age: 12, status: 'En camino', specialization: 'Express Delivery', rating: 4.8, location: 'En route to Fire Nation', caretaker: 'Airbender Kai', completedJobs: 189, description: 'Fastest bison in our fleet, perfect for urgent deliveries.' },
    ...
    { id: 4, name: 'Thunder', age: 15, status: 'Mantenimiento', specialization: 'Heavy Cargo', rating: 4.7, location: 'Republic City Depot', caretaker: 'Veteran Bumi', completedJobs: 312, description: 'Our strongest bison, capable of carrying the heaviest loads.' },
