...
export class Inventory {
  ...
  readonly bisonData: Signal<Bison[]> = signal([
    { id: 1, name: 'Appa Jr.', age: 8, status: 'Available', specialization: 'Long Distance', rating: 5, location: 'Air Temple Island', caretaker: 'Master Jinora', completedJobs: 247, description: 'Descendant of the legendary Appa, specializes in cross-nation deliveries.' },
    ...
    { id: 3, name: 'Cloudy', age: 6, status: 'Available', specialization: 'Fragile Items', rating: 4.9, location: 'Ba Sing Se Station', caretaker: 'Master Opal', completedJobs: 156, description: 'Gentle and careful, ideal for transporting delicate cargo.' },
    ...
    { id: 5, name: 'Whisper', age: 4, status: 'Available', specialization: 'Stealth Delivery', rating: 4.6, location: 'Northern Air Temple', caretaker: 'Master Ikki', completedJobs: 98, description: 'Young but skilled, perfect for discrete and quiet deliveries.' },
    { id: 6, name: 'Breeze', age: 10, status: 'Available', specialization: 'Passenger Transport', rating: 4.9, location: 'Southern Water Tribe', caretaker: 'Airbender Meelo', completedJobs: 203, description: 'Comfortable and smooth flying, great for passenger services.' }
  ]);
  ...
  fleetStatistics = computed(() => ({
    ...
    availableBison: this.bisonData().filter(b => b.status === 'Available').length,
